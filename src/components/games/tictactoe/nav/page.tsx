          ...
          <div className="flex mx-auto justify-center items-center">
            <div className="w-[600px] h-full flex flex-row items-center justify-between md:mr-20">
              <div className="flex items-center justify-between w-full h-auto border border-[#7042f861] bg-[#0300145e] mr-[15px] px-[20px] py-[10px] rounded-full text-gray-200">
                ...
                <NavLink to="/" className=" cursor-pointer mx-auto  px-2 text-xl">
                  Home
                </NavLink>

                <NavLink to="#skills" className="cursor-pointer mx-auto  p-1 text-xl">
                  Cooperation
                </NavLink>
                <NavLink to="/menu/entertainment" className="cursor-pointer mx-auto  p-1 text-xl animate-in">
                  Games
                </NavLink>
                <NavLink to="#projects" className=" cursor-pointer mx-auto px-2 text-xl">
                  Events
                </NavLink>
              </div>
